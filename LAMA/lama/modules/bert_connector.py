...
class Bert(Base_Connector):
    ...
    def __init__(self, args, vocab_subset = None):
        ...
        self._model_device = torch.device(args.device) # added line
        print("Using device:", self._model_device)

        self.masked_bert_model.to(self._model_device)  # added line
    ...
    def get_batch_generation(self, sentences_list, logger= None,
                             try_cuda=False): # originally True
